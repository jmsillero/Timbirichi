...
public class CheckPreferencesDatabaseUseCase extends UseCase<Boolean> {

    IProductRepository productRepository;

    @Inject
    public CheckPreferencesDatabaseUseCase(@Named(EXCECUTOR_THREAD_NAMED)Scheduler executorThread,
    ...
    protected Observable<Boolean> createObservableCaseUse() {
        return productRepository.checkDatabase();
    }
}

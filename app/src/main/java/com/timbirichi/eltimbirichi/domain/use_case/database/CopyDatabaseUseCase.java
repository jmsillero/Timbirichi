...
public class CopyDatabaseUseCase extends UseCase<Boolean> {

    IProductRepository productRepository;

    @Inject
    public CopyDatabaseUseCase(@Named(EXCECUTOR_THREAD_NAMED)Scheduler executorThread,
    ...
    protected Observable<Boolean> createObservableCaseUse() {
        return productRepository.copyDatabase();
    }
}
